...
for i in range(liczbaPowtorzen):
    ...
    while(indeks1!=1 or indeks2!=1):
        ...
        while(fl2!=True): #and indeks<1000000):
            ...
            for indeksSciezka2 in indeksySciezki2:
                for indeksSciezka in indeksySciezki:
                    sciezkacopy=copy.deepcopy(sciezka)
                    sciezkacopy[indeksSciezka]=sciezka[indeksSciezka2]
                    sciezkacopy[indeksSciezka2]=sciezka[indeksSciezka]
                    if best2[2]>ObliczLacznyKoszt(odleglosciWzorzec,sciezkacopy):
                        best2=(indeksSciezka2,indeksSciezka,ObliczLacznyKoszt(odleglosciWzorzec,sciezkacopy))
            if best2[0]!=-1:
                pom=sciezka[best2[0]]
                sciezka[best2[0]]=sciezka[best2[1]]
                sciezka[best2[1]]=pom
            else: fl2=True
            indeks2+=1
            if indeks2%100==0: 
    ...
    opis="Steepest wym. punktow, "+plik+", odleglosc="+str(kosztLaczny)
...
print("Steepest, wymiana punktow")
